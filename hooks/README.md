...
| `inspector-lsp-gate.sh` | `PreToolUse` | Intended to block `Read/Glob/Grep` until LSP is initialized — currently inactive pending Claude Code platform support for agent-scoped hooks |
